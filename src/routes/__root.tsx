...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Lumière is a fine-casual restaurant serving seasonal Mediterranean dishes, architectural plating, and warm shared-table hospitality." },
      { name: "author", content: "Lumière Restaurant" },
      ...
      { name: "twitter:site", content: "@lumiere_dining" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=JetBrains+Mono:wght@400;500&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&display=swap",
      },
